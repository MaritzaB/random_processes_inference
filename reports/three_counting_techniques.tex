...
%\begin{tcolorbox}
	% \begin{mydef}
		\begin{itemize}
		\item Permutaci\'on par: aquella en la que el total de inversiones es un entero par.
		\item permutaci\'on impar: aquella en la que el total de inversiones es un entero impar. 
		\end{itemize}
	% \end{mydef} 
%\end{tcolorbox}
